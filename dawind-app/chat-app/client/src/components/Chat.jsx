...
export default function Chat() {
  ...
  function sendMessage(ev, file = null) {
    ...
    setNewMessage("");
    // setMessages(prevState => ([...prevState, { text: newMessage, isOur: true }]))
    if (!file) {
                  ...
                  >
                    ...
                    >
                      ...
                      {item.file && (
                        ...
                        <a
                          href={`${axios.defaults.baseURL}/src/assets/uploads/${item.file}`}
                          target="_blank"
