        ...
        <div className="col-md-4 col-sm-6 text-sm-start text-center">
          ...
          <div>
            <address className="text-white fs-6">
              Endereço: Rua do endereço N° 46,<br />
              São Paulo, SP<br />
              CEP: 131103-123
            </address>
            <a className="mt-3 d-block mb-1 text-white" href="tel:(11) 9 9999-9999">
              (11) 9 9999-9999
            </a>
            <a className="mt-3 d-block mb-1 text-white" href="mailto:contato@email.com">
              contato@email.com
            </a>
