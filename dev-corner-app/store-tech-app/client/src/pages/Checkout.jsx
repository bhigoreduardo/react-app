    ...
    <Container className="py-5">
      <div className="row">
        <div className="col-md-7 col-12">
          ...
          <nav style={{ "--bs-breadcrumb-divider": ">" }} aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item"><Link className="text-dark total-price" to="/carrinho">Carrinho</Link></li>&nbsp;/&nbsp;
              <li className="breadcrumb-ite total-price active" aria-current="page">Informações</li>&nbsp;/&nbsp;
              <li className="breadcrumb-item total-price active">Frete</li>&nbsp;/&nbsp;
              <li className="breadcrumb-item total-price active" aria-current="page">Pagamento</li>
            </ol>
          </nav>
          ...
          <form className="d-flex gap-2 flex-wrap justify-content-between">
            ...
            <div className="w-100">
              <div className="d-flex justify-content-between align-items-center">
                <Link to="/carrinho" className="text-dark"><BiArrowBack className="me-2" />Retornar ao carrinho</Link>
                <Link to="/loja" className="button">Continuar comprando</Link>
              </div>
            </div>
          </form>
        </div>
        ...
        <div className="col-md-5 col-12">
          <div className="border-bottom py-4">
            {
              Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="d-flex gap-2 mb-2 align-align-items-center">
          ...
          <Link to="/" className="button">Fazer pedido</Link>
        </div>
      </div>
    </Container>
  );
