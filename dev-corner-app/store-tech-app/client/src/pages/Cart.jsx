            ...
            <div className="cart-data py-3 mb-2 row justify-content-between align-items-center">
              ...
              <div className="col-sm-4 col-12">
                ...
                <div className="d-flex align-items-center gap-2">
                  <input className="form-control" type="number" min={1} max={products[0].stock} placeholder="Quantidade" />
          ...
          <div className="col-12 py-2 mt-4">
            <div className="d-md-flex d-block justify-content-between align-items-baseline">
              ...
              <div className="d-flex flex-column align-items-end">
                ...
                <Link to="/finalizar-compra" className="button">Finalizar compra</Link>
              </div>
            </div>
          </div>
        </div>
