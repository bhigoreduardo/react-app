        ...
        <div className="row">
          <div className="col-lg-6 col-md-7 col-12">
            <div className="main-product-image mb-2">
              <ReactImageZoom width={594} height={600} zoomWidth={600} img={products[0].thumbnail} />
            </div>

            <div className="other-product-images d-flex flex-wrap gap-2">
              <div className="col-5">
                <img src={products[0].thumbnail} className="img-fluid" alt={products[0].title} />
              </div>
              <div className="col-5">
                <img src={products[0].cover} className="img-fluid" alt={products[0].title} />
              </div>
            </div>
          </div>
            ...
            <div className="main-product-details">
              ...
              <div className="border-bottom py-3">
                ...
                <div className="d-flex align-items-center gap-1">
                  <ReactStars count={5} size={24} value={products[0].stars} edit={false} activeColor="#ffd700" />
                  <p className="mb-0 t-review">( 2 Avaliações )</p>
                </div>
                <a className="review-btn" href="#">Escrever uma avaliação</a>
              </div>
              ...
              <div className="py-3">
                ...
                <div className="d-xl-flex d-block align-items-center gap-2 flex-row mt-2 mb-3">
                  <div className="d-flex gap-1 align-items-center mb-xl-0 mb-2">
                    ...
                    <input type="number" min={1} max={products[0].stock} className="form-control" style={{ width: "70px" }} />
                  </div>
                  <div className="d-flex align-items-center gap-3">
                    <button className="button border-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop" type="button">Adicionar ao carrinho</button>
                    <button className="button border-0">Comprar agora</button>
                  </div>
                </div>
              </div>
              <div className="d-flex align-items-center gap-2">
                <button type="button" className="button border-0"><TbGitCompare className="fs-5 me-2" />Comparar</button>
                <button type="button" className="button border-0"><AiOutlineHeart className="fs-5 me-2" />Favoritar</button>
              </div>
              ...
              <div className="d-flex gap-2 align-items-center my-3">
                ...
                <button type="button" onClick={() => copyToClipboard(products[0].title)} className="button border-0">Copiar produto</button>
                </div>
            </div>
          </div>
        </div>
      ...
      <Container className="reviews-wrapper py-5">
        ...
        <div className="review-inner-wrapper">
          <div className="review-head d-sm-flex d-block mb-sm-0 mb-2 justify-content-between align-items-end">
            ...
            {orderedProduct && (
              <button type="button" className="button border-0">Fazer avaliação</button>
            )}
          </div>
          <div className="review-form py-4">
            ...
            <form className="d-flex flex-column gap-2">
              ...
              <textarea className="w-100 form-control" cols="30" rows="4" placeholder="Insira um commentário"></textarea>
              <button className="button border-0 align-self-end">Enviar avaliação</button>
            </form>
          </div>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header py-2 px-2 border-0">
              <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="close" role="button"></button>
            </div>

            <div className="modal-body py-0">
              <div className="d-flex align-items-center">
                <div className="flex-grow-1 w-50">
                  <img src={products[0].thumbnail} alt={products[0].title} className="img-fluid" />
                </div>
            ...
            <div className="modal-footer border-0 py-0 justify-content-center gap-3">
              <button type="button" className="button border-0" data-bs-dismiss="modal">Ir ao carrinho</button>
              <button type="button" className="button border-0">Finalizar compra</button>
            </div>

            <div className="d-flex justify-content-center py-3">
              <Link to="/" className="text-dark text-decoration-underline">Continuar comprando</Link>
            </div>
          </div>
        </div>
      </div>
