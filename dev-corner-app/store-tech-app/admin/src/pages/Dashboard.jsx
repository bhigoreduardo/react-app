...
import { dashboardColumn, dashboardTableHeader, dashboardTableData } from "../utils/data";
  ...
  return (
    <div>
      ...
      <div className="mt-4 overflow-auto">
        ...
        <div className="w-100">
          <Table columns={dashboardTableHeader} dataSource={dashboardTableData} />
        </div>
      </div>
    </div>
  );
