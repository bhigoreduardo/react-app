...
const FormBrand = ({ setIsForm }) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <input type="text" id="title" name="title" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.title} placeholder="Nome da marca" className="d-block w-100" />
